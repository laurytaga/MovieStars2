...
class SeenViewController: UIViewController, UISearchBarDelegate{
    ...
    @IBOutlet weak var tableSeen: UITableView!
    ...
    override func viewDidLoad() {
        ...
        tableSeen.addSubview(refreshControl)
        
        //AQUI SERIA A UN SEENMOVIES()
        seenMovies()
        
        NSNotificationCenter.defaultCenter().addObserver(self, selector: #selector(SeenViewController.orderTable(_:)), name: "reload", object: nil)
        
        NSNotificationCenter.defaultCenter().addObserver(self, selector: #selector(SeenViewController.orderTableByRating(_:)), name: "reload2", object: nil)
    }
    ...
    //AQUI IRIA EL SEEN MOVIES
    func seenMovies(){
        let urlString = "http://lgadevelopment.esy.es/MovieLibrary/PeliculasVistas/obtenerPeliculasVistas.php?user=\(user!)"
    ...
    func getPelicula(title: String) {
        ...
        //poner el link del php???
        
        let urlString : String = "http://lgadevelopment.esy.es/MovieLibrary/PeliculasVistas/detallePeliculaVista.php?title=\(title)&user=\(user!)"
    ...
    func deletePeliculaVista(title:String, user:String){
    ...
    func parseMovieJson(json:SwiftyJSON.JSON){
        ...
        for peliculaVista in json["peliculaVista"].arrayValue {
...
extension SeenViewController : UITableViewDataSource{
    ...
    func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        let cell:SeenTableViewCell = tableView.dequeueReusableCellWithIdentifier("CellSeen", forIndexPath: indexPath) as! SeenTableViewCell
...
extension SeenViewController : UITableViewDelegate{
    
    func tableView(tableView: UITableView, didSelectRowAtIndexPath indexPath: NSIndexPath) {
        // cell selected code here
        let myDetail : DetailSeenVC = self.storyboard?.instantiateViewControllerWithIdentifier("detailSeen") as! DetailSeenVC
