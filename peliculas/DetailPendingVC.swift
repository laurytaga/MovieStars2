...
class DetailPendingVC: UIViewController {
    ...
    @IBOutlet weak var duratin: UILabel!
    ...
    @IBAction func translateES(sender: AnyObject) {
    ...
    @IBAction func translateEN(sender: AnyObject) {
        let headers = ["trakt-api-version":"2","trakt-api-key":"2a87c0a50ef88e8d79cb05973bc6c1fa9826b75f88e01cbc19ff38f8c56c4acf"]
    ...
    @IBAction func edit(sender: AnyObject) {
        if pulsado == false {
            ...
            let urlEditar:NSURL = NSURL(string: "http://lgadevelopment.esy.es/MovieLibrary/PeliculasPendientes/actualizarPeliculaPendiente.php")!
